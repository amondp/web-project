...
class viewAll extends AbstractController
{
    ...
    public function index()
    {
       ...
       foreach($orders as $pro){
           ...
           $data = explode('=', $pro->getOrderdetails()); // get the raw serialized order, breaking when we see the equals
		   
		   $output .= '<td>'; //next column
           $data = explode('=', $pro->getOrderdetails());
